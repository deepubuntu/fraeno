...
## Hosted service releases

The GitHub App, access service, deployment controls, and operational
infrastructure are maintained separately from this public runner repository.
A hosted-service release never changes the runner digest in a customer
repository. Public runner releases remain independent and reproducible here.
